...
nc_sif = dataset.createVariable('SIF', np.float32, ('vegp','time'),fill_value=-999.9)
nc_gpp = dataset.createVariable('GPP', np.float32, ('vegp','time'),fill_value=-999.9)
nc_lai = dataset.createVariable('LAI', np.float32, ('vegp','time'),fill_value=-999.9)
nc_apar = dataset.createVariable('APAR', np.float32, ('vegp','time'),fill_value=-999.9)
nc_aparcab = dataset.createVariable('APAR_Cab', np.float32, ('vegp','time'),fill_value=-999.9)
nc_par = dataset.createVariable('PAR', np.float32, ('vegp','time'),fill_value=-999.9)
nc_swdown = dataset.createVariable('SWDOWN', np.float32, ('vegp','time'),fill_value=-999.9)
nc_pres = dataset.createVariable('PRES', np.float32, ('vegp','time'),fill_value=-999.9)
nc_ta = dataset.createVariable('TA', np.float32, ('vegp','time'),fill_value=-999.9)
nc_ea = dataset.createVariable('EA', np.float32, ('vegp','time'),fill_value=-999.9)
...
nc_lai[:,:] = lai_out
nc_apar[:,:] = apar_out
nc_aparcab[:,:] = aparcab_out
nc_par[:,:] = par_out
nc_swdown[:,:] = swdown_out
nc_pres[:,:] = pres_out
nc_ta[:,:] = ta_out
nc_ea[:,:] = ea_out
