...
!HEW-ADD: added nrun, ...
  ...
  USE mo_diagnostics, ONLY: rgpp,rnpp,rnep,raet,rpet,ress,resf,rgrw,rmnt,nppp, &
                       ...
                       &   rswdown_diurnal, rpres_diurnal, rta_diurnal, rea_diurnal
...
!     CALL savefnc(TRIM(outdir)//'par_scope_cab.nc', PAR_scope_cab,lat,lon,nrun,outt,ng,sp)
     ...
     CALL savefnc_diurnal(TRIM(outdir)//'rlai_diurnal.nc',rlai_diurnal,nrun,365,24,vp,sp)
     CALL savefnc_diurnal(TRIM(outdir)//'rapar_diurnal.nc',rapar_diurnal,nrun,365,24,vp,sp)
     ...
     CALL savefnc_diurnal(TRIM(outdir)//'rpres_diurnal.nc',rpres_diurnal,nrun,365,24,vp,sp)
     CALL savefnc_diurnal(TRIM(outdir)//'rta_diurnal.nc',rta_diurnal,nrun,365,24,vp,sp)
     CALL savefnc_diurnal(TRIM(outdir)//'rea_diurnal.nc',rea_diurnal,nrun,365,24,vp,sp)
