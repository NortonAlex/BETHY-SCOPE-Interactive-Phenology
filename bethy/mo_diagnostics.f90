...
!ANorton-ADD-150107. Fluorescence arrays
  ...
  REAL, ALLOCATABLE, DIMENSION(:,:,:,:) :: rfsyieldu_diurnal
  REAL, ALLOCATABLE, DIMENSION(:,:,:,:) :: rfsyieldh_diurnal
  REAL, ALLOCATABLE, DIMENSION(:,:,:,:) :: rpyieldu_diurnal
  REAL, ALLOCATABLE, DIMENSION(:,:,:,:) :: rpyieldh_diurnal
  REAL, ALLOCATABLE, DIMENSION(:,:,:,:) :: rnpqyieldu_diurnal
  REAL, ALLOCATABLE, DIMENSION(:,:,:,:) :: rnpqyieldh_diurnal
...
!  enddo
  ...
  ! Canopy average PSII quantum yields
  ALLOCATE( rfsyieldu_diurnal (0:nrun,365,tspd,vp) )
  rfsyieldu_diurnal = -999.9
  ALLOCATE( rfsyieldh_diurnal (0:nrun,365,tspd,vp) )
  rfsyieldh_diurnal = -999.9
  ALLOCATE( rpyieldu_diurnal (0:nrun,365,tspd,vp) )
  rpyieldu_diurnal = -999.9
  ALLOCATE( rpyieldh_diurnal (0:nrun,365,tspd,vp) )
  rpyieldh_diurnal = -999.9
  ALLOCATE( rnpqyieldu_diurnal (0:nrun,365,tspd,vp) )
  rnpqyieldu_diurnal = -999.9
  ALLOCATE( rnpqyieldh_diurnal (0:nrun,365,tspd,vp) )
  rnpqyieldh_diurnal = -999.9
  !WOK-CHG-071031 renamed variables for actual and potential evapotranspiration
...
!$taf next required = nrun, outint, vp
  ...
  DEALLOCATE( rfsyieldu_diurnal )
  DEALLOCATE( rfsyieldh_diurnal )
  DEALLOCATE( rpyieldu_diurnal )
  DEALLOCATE( rpyieldh_diurnal )
  DEALLOCATE( rnpqyieldu_diurnal )
  DEALLOCATE( rnpqyieldh_diurnal )
