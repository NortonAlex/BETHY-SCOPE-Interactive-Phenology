...
!ANorton-ADD-150107. Fluorescence arrays
  ...
  REAL, ALLOCATABLE, DIMENSION(:,:,:,:) :: rf_etau_toc_diurnal
  REAL, ALLOCATABLE, DIMENSION(:,:,:,:) :: rf_etah_toc_diurnal
...
!  enddo
  ...
  ALLOCATE( rf_etau_toc_diurnal (0:nrun,365,tspd,vp) )
  rf_etau_toc_diurnal = -999.9
  ALLOCATE( rf_etah_toc_diurnal (0:nrun,365,tspd,vp) )
  rf_etah_toc_diurnal = -999.9
  !WOK-CHG-071031 renamed variables for actual and potential evapotranspiration
...
!$taf next required = nrun, outint, vp
  ...
  DEALLOCATE( rf_etau_toc_diurnal )
  DEALLOCATE( rf_etah_toc_diurnal )
