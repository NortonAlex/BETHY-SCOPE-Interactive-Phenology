...
!WOK-ADD-070725 monthly diagnostics of various status variables
  REAL, ALLOCATABLE, DIMENSION (:,:,:) :: rrhos, rpasm, rlai, rfpar, rdapar
...
!AJN-ADD-170508 daily storage of apar
  REAL, ALLOCATABLE, DIMENSION (:) :: ddapar
...
!  enddo
  ...
  ALLOCATE( drhos(vp) )
  drhos = 0.
  ALLOCATE( rdapar(0:nrun,outt,ng) )
  rdapar = 0.
