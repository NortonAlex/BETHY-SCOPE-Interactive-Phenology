...
! the current diurnal time step loop forcing data
  REAL, ALLOCATABLE, DIMENSION (:)   :: ctswdown,ctta,ctea,ctpair
...
!$taf next required = vp
    ...
    DEALLOCATE (ctswdown,ctta,ctea,ctpair)
...
! .. Local scalars ..
    ...
    REAL    :: xswdown, xta, xea, xpair  ! sum of current time steps climate variables
