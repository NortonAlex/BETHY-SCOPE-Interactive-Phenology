...
## Select dominant vegetation type for the lat-lon box
dom_vtype = 1
...
print '   Selected dominant vegetation type: PFT',dom_vtype
...
region_inds = np.squeeze(np.where((vtype1 == dom_vtype) & (lats_gps > lat0) & (lats_gps < lat1) & (lons_gps > lon0) & (lons_gps < lon1)))
